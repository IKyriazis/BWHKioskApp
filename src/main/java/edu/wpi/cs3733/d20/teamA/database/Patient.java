...
public class Patient implements ITableable<Patient> {
    ...
    public Patient(String firstName, String lastName, String healthInsurance, String dateOfBirth, int heightFeet, int heightInches, double weight, String symptoms, String allergies, String currentMeds){
    ...
    public ArrayList<JFXTreeTableColumn<Patient, ?>> getColumns() {
        ...
        column5.setCellValueFactory(param -> param.getValue().getValue().heightFeetProperty().asObject());

        JFXTreeTableColumn<Patient, Integer> column6 = new JFXTreeTableColumn<>("Height in Inches");
        column6.setCellValueFactory(param -> param.getValue().getValue().heightInchesProperty().asObject());
        ...
        return new ArrayList<>(List.of(column1, column2, column3, column4, column5, column6, column7, column8, column9, column10));
    }
}
