...
public class FlowerOrderController extends AbstractController implements IDialogController {
  ...
  //      TempFlower flow = new TempFlower(f.getTypeFlower(), f.getColor(),
  // f.getQuantitySelected());
  ...
  //
  //    JFXTreeTableColumn<TempFlower, Integer> columnNum = new JFXTreeTableColumn<>("Number in
  // Order");
  ...
  //            dialog.getDialogContainer(), "Order Placed", "Order #" + i + " placed
  // successfully");
  //      } catch (Exception e) {
  //        e.printStackTrace();
  //      }
