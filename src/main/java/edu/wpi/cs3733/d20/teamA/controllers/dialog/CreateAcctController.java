  ...
  public void submitEmployee() {
    ...
    ThreadPool.runBackgroundTask(
        () -> {
          ...
          //                () -> {
          //                  // tell user we are scanning for a card
          //                  DialogUtil.simpleErrorDialog("Started Scanning", "We are looking for
          // your card.");
          //                });
          //            String rfid = scanRFID();
          //
          //            if (rfid != null) {
          //              // if the rfid card is associated with a user it will return the username
          // which is not
          //              // null
          //              // if there is a username associated with this card then we pop up a
          // dialog
          //              if (!eDB.getUsername(rfid).isEmpty()) {
          //                Platform.runLater(
          //                    () -> {
          //                      DialogUtil.simpleErrorDialog(
          //                          "Duplicate Card", "There is another account associated with
          // this card.");
          //                    });
          //              } else {
          //                // else if the username is null it means no one has been assigned that
          // card
          ...
          //                  () -> {
          //                    DialogUtil.simpleErrorDialog(
          //                        "Read Fail", "There was an error reading the card please try
          // again");
          //                  });
          //              clearFields();
          //            }
