...
public class ITServicesController extends AbstractController {
    ...
    @FXML
    private JFXComboBox<Node> ITTicketLocation;
    @FXML
    private JFXComboBox<String> ITTicketCategory;
    @FXML
    private JFXTextArea ITTicketDescription;
    @FXML
    private GridPane ticketTablePane;
    @FXML
    private JFXComboBox<String> statusChangeStatus;
    @FXML
    private JFXTextField statusChangeName;
    @FXML
    private StackPane ITStackPane;
    @FXML
    private JFXButton changeStatusBtn;
    @FXML
    private JFXButton descriptionBtn;
    @FXML
    ...
    /**
     * Sets up the ITTicket database, initializes the choices for comboBoxes, sets up the table, and sets up an event handler to track when the mouse is selecting the table.
     */
    ...
    /**
     * Checks if the update status button can be enabled by checking for improper or unfinished values in fxml
     */
    ...
    /**
     * Checks if the submit ticket button can be enabled by checking for improper or unfinished values in fxml
     */
