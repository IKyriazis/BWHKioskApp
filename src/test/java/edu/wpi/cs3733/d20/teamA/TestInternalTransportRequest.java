...
public class TestInternalTransportRequest {
  ...
  public void testGetRequestNumber() {
    InternalTransportRequest itr =
        new InternalTransportRequest("AAAAAA", "biscuit", "torn", new Timestamp(System.currentTimeMillis()), "done", "harry");
  ...
  public void testGetStart() {
    InternalTransportRequest itr =
        new InternalTransportRequest("BBBBBB", "biscuit", "torn", new Timestamp(System.currentTimeMillis()), "done", "harry");
  ...
  public void testGetDestination() {
    InternalTransportRequest itr =
        new InternalTransportRequest("CCCCCC", "biscuit", "torn", new Timestamp(System.currentTimeMillis()), "done", "harry");
